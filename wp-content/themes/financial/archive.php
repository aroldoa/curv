        ...
        <section class="single-blog-area">
            <div class="container">
                <div class="row">
                    ...
                    <h3 style="text-align: center; padding-bottom: 30px !important;"><?php
                        if ( is_day() ) :
                            printf( __( 'Daily Archives: %s', 'financial' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( __( 'Monthly Archives: %s', 'financial' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'financial' ) ) );

                        elseif ( is_year() ) :
                            printf( __( 'Yearly Archives: %s', 'financial' ), get_the_date( _x( 'Y', 'yearly archives date format', 'financial' ) ) );

                        else :
                            _e( 'Archives', 'financial' );
